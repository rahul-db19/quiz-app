INSERT INTO questionsdb.question (id,category,difficulty_level,option1,option2,option3,option4,question_title,right_answer)
VALUES
    (1,'JAVA','Easy','class','interface','extends','implements','Which Java keyword is used to create a subclass?','extends'),
    (2,'Java','Easy',4,5,6,'Compile error','"What is the output of the following Java code snippet? int x = 5; System.out.println(x++);"',5),
    ...
    (12,'Python','Easy','"[1, 2, 3]"','"[1, 2, 3, 4]"','"[4, 3, 2, 1]"','Error',' "What is the output of the following Python code snippet? x = [1, 2, 3] x.append(4) print(x)"','"[1, 2, 3, 4]"'),
